...
- **C4 — 상태 Proposed**: 본 spec의 근거 결정 [[08-Decisions|D-041]]/[[08-Decisions|D-042]]/[[08-Decisions|D-044]]/[[08-Decisions|D-045]]는 모두 **Proposed(미승인)**다([[08-Decisions]] D-041 서문). spec-reviewer + 도메인 리뷰 게이트에서 ratify되기 전에는 본 spec도 `draft`이며 구현 착수 전이다.
