      ...
      "orcs": [
        {
          ...
          "agentSignals": [
            { "signal": "cmdline", "tier": "B", "matchedType": "claude-code", "ruleId": "claude-code/cmdline.signature" }
          ],
          "status": "active",
...
| `agentSignals` | array | 아니오 | redaction-safe(ruleId만), **≥1 (minItems 1, SPEC-003 §2.2 matchedSignals 보장)** | [[SPEC-003-agent-detection]] §2.2 |
