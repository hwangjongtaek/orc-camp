...
- **Terminal Workspace Phase 2/3 R-* 커버리지**(2026-07-03, [[08-Decisions|D-047]]~[[08-Decisions|D-051]] **Accepted 승인**): R-API-007(§2.7, [[SPEC-104-control-mode-bridge]] 저지연 브리지)·R-CTRL-010(§2.6, [[SPEC-402-orchestration]] broadcast)·R-UI-013(§2.4, broadcast UI) → spec/AC. 2026-07-03 승인으로 정식 편입됐고 각 family 표에 `(accepted)`로 반영한다. 이들은 Phase 2/3 확장 요구사항(MVP 58-P0 집합과 별개 축)이며 각 spec AC(SPEC-104-AC-01~11·SPEC-402-AC-01~10·SPEC-203-AC-18)로 orphan-0 커버된다.
...
| R-UI-013 (accepted) | **SPEC-203** (server SPEC-402) | SPEC-203-AC-18 | C | **broadcast UI**(대상 다중 선택·단일 ConfirmModal·per-orc 결과 집계·waiting toast 연결·a11y). accepted 2026-07-03([[08-Decisions|D-050]]/[[08-Decisions|D-051]]) |
...
| R-CTRL-010 (accepted) | **SPEC-402** (write 경로 SPEC-400, audit SPEC-600, UI SPEC-203) | SPEC-402-AC-01~10; SPEC-203-AC-18 | I·C | **command broadcast**(composed-input only·단일 confirm·per-orc 순차·중복 de-dup·exposure 독립·best-effort 집계·`control.broadcast` batch audit 비저장·단일 camp). accepted 2026-07-03([[08-Decisions|D-050]]/[[08-Decisions|D-051]]) |
...
| R-API-007 (accepted) | **SPEC-104** (frame·session SPEC-103, chokepoint SPEC-006) | SPEC-104-AC-01~11 | I·E | **control-mode 브리지** 저지연 트리거(HYBRID `%output`=dirty-signal·allowlist=∅ stdin line fail-close·size-neutral ignore-size·단일 scheduler handoff·fallback 투명·coexist default polling). accepted 2026-07-03([[08-Decisions|D-047]]/[[08-Decisions|D-048]]/[[08-Decisions|D-049]]) |
...
| 2 Server·API | SPEC-100/101/102/103 · **SPEC-104**(approved) | draft (SPEC-103/104 approved) | full-product 게이트(2026-06-27) 통과, 미승격. **SPEC-104**(control-mode 브리지, R-API-007)는 [[08-Decisions|D-047]]~[[08-Decisions|D-049]] **2026-07-03 승인·approved**, 구현 착수 |
...
| 5 Control | SPEC-400/401 · **SPEC-402**(approved) | draft (SPEC-400/401/402 approved) | 동일. **SPEC-402**(orchestration broadcast, R-CTRL-010)는 [[08-Decisions|D-050]]/[[08-Decisions|D-051]] **2026-07-03 승인·approved**, 구현 착수 |
