...
- **임계 상수(SSOT, 초; 튜닝 대상)**: `PRESTIGE_TIER1_MIN_UPTIME_S = 3_600`(1h) / `TIER2 = 14_400`(4h) / `TIER3 = 43_200`(12h). 경계 inclusive(≥). manifest `prestige`에 character별 override는 두지 않는다(공통).
...
- **SPEC-302-AC-14** (R-P2-008, D-040) — uptime 폴백 + precedence
  - Given tiered character, `usage.cumulativeTokens=null` & `cumulativeCostUsd=null`, `uptimeSec` = 1800 / 3600 / 14400 / 43200 / null fixture에서
  - Then `rawTier` = 0 / 1 / 2 / 3 / 0 이다(uptime 경계 3600/14400/43200초 inclusive; uptimeSec=null이면 0).
